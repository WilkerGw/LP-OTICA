                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400 mt-1">Domingos e feriados: Fechado</p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-primary font-bold w-full sm:w-auto text-lg">
                                <Smartphone className="mr-2 h-5 w-5" />
                                Fale pelo WhatsApp
                            </Button>
                            <Button size="lg" variant="glass-dark" className="w-full sm:w-auto text-lg text-primary hover:text-primary">
                    ...
                    {/* Right Column: Map */}
                    <div className="h-[400px] lg:h-auto rounded-2xl overflow-hidden shadow-lg border border-slate-200 bg-slate-100 relative">
                        <iframe
